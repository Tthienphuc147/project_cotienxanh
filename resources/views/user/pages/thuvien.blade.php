...
@section('content')
  ...
  <div class="blog jumbotron">
    <div class="container">
       <div class="col-lg-12 col-centered well text-center">
             ...
             <div class="blog-post">
                <div class="img-date">
                   <div class="img-effect">
                      <a href="/album/1">
                      <img class="img-responsive" src="/public/user/img/blog2.jpg" alt="">
                      </a>
                   </div>
                </div>
                <div class="col-md-12">
                   ...
                   <p class="blog-post-title">
                      <a href="/album/1">OH MY SURPRISE HALLOWEEN</a>
                   </p>
                   <div class="post-info">
                      <!-- Post Author -->
                      <p><i class="fa fa-user"></i><a href="#">Cô tiên xanh</a></p>
                      <!-- Post Comments -->
                      <p><i class="fa fa-calendar"></i><a href="#">12/08/2020</a></p>
                   </div>
                   <a class="btn" href="/album/1">Xem album<i class="fa fa-angle-right"></i></a>
                </div>
             </div>
